...
const products: Product[] = [
  { id: "p1", name: "Mukimo", kind: "cooked_food", priceMinor: 150, lastKnownCostMinor: null, lowStockLevel: null, active: true, categoryId: null, locationId: "l1" },
  { id: "p2", name: "Chips", kind: "cooked_food", priceMinor: 100, lastKnownCostMinor: null, lowStockLevel: null, active: true, categoryId: null, locationId: "l1" },
  { id: "p3", name: "Githeri", kind: "cooked_food", priceMinor: 120, lastKnownCostMinor: null, lowStockLevel: null, active: true, categoryId: null, locationId: "l1" },
  { id: "p4", name: "Beef stew", kind: "cooked_food", priceMinor: 180, lastKnownCostMinor: null, lowStockLevel: null, active: true, categoryId: null, locationId: "l1" },
];
