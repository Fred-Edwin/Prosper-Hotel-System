 ...
 *
 * Where it is weak: Janiffer genuinely does switch — receive a delivery, issue
 * to the kitchen, sell, count — and for her the trip through home is a real
 * cost. Six links is where this frame is least comfortable.
 */

import { staffNav, roleName, roleLocation, type StaffRole } from "./nav";
        ...
        {inTask ? (
          <>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[11px] leading-tight text-muted-foreground capitalize">
                {roleLocation[role]} · {roleName[role]}
              </div>
            </div>
          </>
        ) : (
          <div className="min-w-0 flex-1 px-2">
            ...
            <div className="text-[11px] leading-tight text-muted-foreground">
              {roleName[role]} · Thursday 6 August
            </div>
          </div>
        )}
      </header>
...
export const homeNote = "Home screen · task owns the whole screen";
